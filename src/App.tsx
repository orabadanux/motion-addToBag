  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center bg-slate-50 overflow-hidden">
      <div className="relative w-[280px] h-[610px] bg-neutral-100 rounded-3xl shadow-xl overflow-hidden px-3">
        ...
        {/* Layout Content */}
        <div className={`relative z-20 transition-all duration-500 ${isAnimating ? 'scale-[0.96]' : ''}`}>
          {/* Top Navigation */}
        ...
        <img
          ...
          className="absolute bottom-0 left-0 w-full h-[34px] z-50 pointer-events-none"
          alt=""
        />
      </div>
    </div>
